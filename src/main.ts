...
import { createMgmtStore, hoursModalData, gradesModalData, syncDialogData, resetPasswordData, inlineHoursData, addStudentData, addStudentDirectData, exportDialogData, setPinData, overviewPanelData, mgmtTableData, editStudentNameData, removeStudentData, addEntryModalData, punchPhotosModalData } from './components/mgmt';
import { compareTableData } from './components/compare';
import { hoursTabData } from './components/hours';
...
Alpine.data('hoursTabData', hoursTabData);
